  ...
  const [isOpen, setOpen] = useState(false)  
    return (
        <div className='trailer3'>
                            ...
                            <img className='trailer-img1' src="https://i.ibb.co/kJSJWdv/51-Lr0-Zu-Ctx-L-AC.jpg" alt="51-Lr0-Zu-Ctx-L-AC" border="0"/>
                                    </div>
                                    <div className='trailer-title'>
                                    <ModalVideo className='modal-video' channel='youtube' autoplay isOpen={isOpen} videoId="aQXh_AaJXaM" onClose={() => setOpen(false)} />
