...
function Zod() {
    ...
    return (
        <div className='trailer1'>
                                ...
                                <img className='trailer-img1' src="https://i.ibb.co/0mDQ22q/PHOTOGRAPHS-TO-BE-USED-SOLELY-FOR-ADVERTISING-PROMOTION-PUBLICITY-OR-REVIEWS-OF-THIS-SPECIFIC-MOTION.jpg" alt="PHOTOGRAPHS-TO-BE-USED-SOLELY-FOR-ADVERTISING-PROMOTION-PUBLICITY-OR-REVIEWS-OF-THIS-SPECIFIC-MOTION" border="0"/>
                                </div>
